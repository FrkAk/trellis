...
const PRIORITIES: Priority[] = [null, 'backlog', 'normal', 'core', 'release-blocker'];
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <Section title="Priority" caption="Three ascending bars. Maps schema backlog / normal / core / release-blocker / null.">
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, alignItems: 'center' }}>
            {PRIORITIES.map((p) => (
